//(function(window, undefined) {
	 ...
	 * @class Graphics
	 * @constructor
	 * @param {Number} width Width of the display area of the graphics content
	 * @param {Number} height Height of the display area of the graphics content
	 */
    ...
    /**
     * Resize the content area of the Graphics object
     * 
    ...
    /**
     * Returns the size of the content area of the Graphics object
     * 
     * @memberOf Graphics.prototype
     * @name getSize
     * @function
	 * @returns {Object} An object with width and height of the Graphics object as properties  
     */
    ...
    /**
     * Clear the content area of the Graphics object
     * 
     * @memberOf Graphics.prototype
     * @name clear
     * @function
...
//        this.shadowOffsetY	= 0;
    ...
    /**
     * Starts a new path. This method is a wrapper function for the 
     * <em><a href="http://dev.w3.org/html5/2dcontext/#dom-context-2d-beginpath">beginPath()</a></em> 
     * method in the <em><a href="http://dev.w3.org/html5/2dcontext/#canvasrenderingcontext2d">CanvasRenderingContext2D</a></em> specification.
     * 
    ...
    /**
     * Closes the current path. This method is a wrapper function for the 
     * <em><a href="http://dev.w3.org/html5/2dcontext/#dom-context-2d-closepath">closePath()</a></em> 
     * method in the <em><a href="http://dev.w3.org/html5/2dcontext/#canvasrenderingcontext2d">CanvasRenderingContext2D</a></em> specification.
     * 
     * @memberOf Shape.prototype
     * @name closePath
    ...
    /**
     * Moves the current drawing point to the given <em>x</em> and <em>y</em> coordinates. This method is a wrapper function for the 
     * <em><a href="http://dev.w3.org/html5/2dcontext/#dom-context-2d-moveto">moveTo()</a></em> 
     * method in the <em><a href="http://dev.w3.org/html5/2dcontext/#canvasrenderingcontext2d">CanvasRenderingContext2D</a></em> specification.
     * 
     * @memberOf Shape.prototype
     * @name moveTo
     * @function
     * @param {Number} x The distance of the end point in pixels to the right taking <em>0</em> as the left most coordinate of the shape.
     * @param {Number} y The distance of the end point in pixels to the down taking <em>0</em> as the top most coordinate of the shape.
     * @returns {Shape} The Shape object
     */
    ...
    /**
     * Draws a straight line segment from the the current drawing point to the given <em>x</em> and <em>y</em> coordinates. This method is a wrapper function for the 
     * <em><a href="http://dev.w3.org/html5/2dcontext/#dom-context-2d-lineto">lineTo()</a></em> 
     * method in the <em><a href="http://dev.w3.org/html5/2dcontext/#canvasrenderingcontext2d">CanvasRenderingContext2D</a></em> specification.
     * 
     * @memberOf Shape.prototype
     * @name lineTo
    ...
    /**
     * Draws a arc from the the current drawing point to the given <em>x</em> and <em>y</em> coordinates with the minimum radius <em>radius</em> and starting and ending angles being <em>startAngle</em> and <em>endAngle</em> respectively. 
     * This method is a wrapper function for the <em><a href="http://dev.w3.org/html5/2dcontext/#dom-context-2d-arc">arc()</a></em> 
     * method in the <em><a href="http://dev.w3.org/html5/2dcontext/#canvasrenderingcontext2d">CanvasRenderingContext2D</a></em> specification.
     * 
     * @memberOf Shape.prototype
     * @name arc
     ...
     * @param {Boolean} anticlockwise The direction of drawing the arc
     * @returns {Shape} The Shape object
     */
    ...
    /**
     * Draws a arc such that the lines drawn from the coordinates <em>x1</em> , <em>y1</em> to the current drawing point and the point given by <em>x2</em> , <em>y2</em> are tangent lines to the circle drawn by completing the arc. The minimum radius of the circle is <em>radius</em>. 
     * This method is a wrapper function for the <em><a href="http://dev.w3.org/html5/2dcontext/#dom-context-2d-arcto">arcTo()</a></em> 
     * method in the <em><a href="http://dev.w3.org/html5/2dcontext/#canvasrenderingcontext2d">CanvasRenderingContext2D</a></em> specification.
     * 
     * @memberOf Shape.prototype
     * @name arcTo
     * @function
     * @param {Number} x1 The distance of the first point in pixels to the right taking <em>0</em> as the left most coordinate of the shape.
     * @param {Number} y1 The distance of the first point in pixels to the down taking <em>0</em> as the top most coordinate of the shape.
     * @param {Number} x2 The distance of the second point in pixels to the right taking <em>0</em> as the left most coordinate of the shape.
     * @param {Number} y2 The distance of the second point in pixels to the down taking <em>0</em> as the top most coordinate of the shape.
     * @param {Number} radius Radius of the arc.
     * @returns {Shape} The Shape object
     */
    ...
    /**
     * Draws a quadratic curve to the point given by <em>x</em> and <em>y</em> coordinates having the point given by <em>cpx</em> and <em>cpy</em> coordinates as the control point. 
     * This method is a wrapper function for the <em><a href="http://dev.w3.org/html5/2dcontext/#dom-context-2d-quadraticcurveto">quadraticCurveTo()</a></em> 
     * method in the <em><a href="http://dev.w3.org/html5/2dcontext/#canvasrenderingcontext2d">CanvasRenderingContext2D</a></em> specification.
     * 
     * @memberOf Shape.prototype
     * @name quadraticCurveTo
     * @function
     * @param {Number} cpx The distance of the control point in pixels to the right taking <em>0</em> as the left most coordinate of the shape.
     * @param {Number} cpy The distance of the control point in pixels to the down taking <em>0</em> as the top most coordinate of the shape.
     * @param {Number} x The distance of the end point in pixels to the right taking <em>0</em> as the left most coordinate of the shape.
     * @param {Number} y The distance of the end point in pixels to the down taking <em>0</em> as the top most coordinate of the shape.
     * @returns {Shape} The Shape object
     */
